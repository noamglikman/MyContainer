...
public:
    ...
    /**
     * @brief Returns an iterator pointing to the first element in reverse order.
     *
     * @param c The container to iterate over.
     * @return ReverseIterator pointing to the beginning (last element).
     */
    static ReverseIterator begin(const MyContainer<T>& c) {
     ...
     *
     * @param c The container to iterate over.
     * @return ReverseIterator pointing past the last element.
     */
    static ReverseIterator end(const MyContainer<T>& c) {
        ReverseIterator it(c);

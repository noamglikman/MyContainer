...
public:
    ...
    /**
     * @brief Static method to get an iterator to the beginning of the container.
     * 
     * @param c Reference to the container.
     * @return OrderIterator pointing to the first element.
     */
    static OrderIterator begin(const MyContainer<T>& c) {
        return OrderIterator(c);
    }

    /**
     * @brief Static method to get an iterator to one past the last element of the container.
     * 
     * @param c Reference to the container.
     * @return OrderIterator pointing one past the last element.
     */
    static OrderIterator end(const MyContainer<T>& c) {
        OrderIterator it(c);
        it.index = c.getData().size();
        return it;
    }
};
